...
public class LoggingAspect {
	...
	public Object executionTime(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		logger.debug("summary : {}", stopWatch.shortSummary()); // 요약정보
	...
	@AfterReturning(value = "execution(* com.ssafy.guestbook.model..GuestBook*.list*(..))", returning = "obj") // try
	...
	@AfterThrowing(value = "execution(* com.ssafy.guestbook.model..GuestBook*.list*(..))", throwing = "exception") // catch
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.guestbook.model..GuestBook*.list*(..))") // finally
